...
LifToken.transferAndCall(_to, _value, _data) `payable` `4000aea0`
...
LifToken.increaseApprovalAndCall(_spender, _addedValue, _data) `payable` `90db623f`
...
LifToken.transferFromAndCall(_from, _to, _value, _data) `payable` `c1d34b89`
...
LifToken.approveAndCall(_spender, _value, _data) `payable` `cae9ca51`
...
LifToken.decreaseApprovalAndCall(_spender, _subtractedValue, _data) `payable` `cb3993be`
