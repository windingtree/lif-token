...
LifTokenTest.approve(_spender, _value) `nonpayable` `095ea7b3`
...
LifTokenTest.totalSupply() `view` `18160ddd`
...
LifTokenTest.transferFrom(_from, _to, _value) `nonpayable` `23b872dd`
...
LifTokenTest.decreaseApproval(_spender, _subtractedValue) `nonpayable` `66188463`
...
LifTokenTest.balanceOf(_owner) `view` `70a08231`
...
LifTokenTest.transfer(_to, _value) `nonpayable` `a9059cbb`
...
LifTokenTest.increaseApproval(_spender, _addedValue) `nonpayable` `d73dd623`
...
LifTokenTest.allowance(_owner, _spender) `view` `dd62ed3e`
...
LifTokenTest.Approval(owner, spender, value) `8c5be1e5`
...
LifTokenTest.Transfer(from, to, value) `ddf252ad`
