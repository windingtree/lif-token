...
contract('LifToken Crowdsale', function(accounts) {
  ...
  it("Should simulate a crowdsale of 7m tokens with on ducth auction stage, using future discount and distribute 3M of the tokens using futurePayments", async function() {
    ...
    try {
      await token.submitBid({ value: web3.toWei(1, 'ether'), from: accounts[1] });
    } catch (error) {
    ...
    let price = parseFloat((await token.getPrice())[0]);
    lastPrice = price;
    assert.equal(price, web3.toWei(5, 'ether'));
    totalWeiSent += price*500000;
    totalTokensBought += 500000;
    await token.submitBid({ value: web3.toWei(5, 'ether')*500000, from: accounts[1] });
    ...
    price = parseFloat((await token.getPrice())[0]);
    lastPrice = price;
    totalWeiSent += price*1000000;
    totalWeiSent += price*500000;
    totalTokensBought += 1000000;
    totalTokensBought += 500000;
    await token.submitBid({ value: price*1000000, from: accounts[2] });
    await token.submitBid({ value: price*500000, from: accounts[3] });
    ...
    await token.submitBid({ value: price*1000000, from: accounts[4] });
    await token.submitBid({ value: price*2000000, from: accounts[5] });
    ...
    await token.submitBid({ value: price*750000, from: accounts[6] });
    await token.submitBid({ value: price*1000000, from: accounts[7] });
    await token.submitBid({ value: price*127451, from: accounts[8] });
  ...
  it("Should simulate a crowdsale of 7m tokens with three dutch auction stages, using future discount and distribute 3M of the tokens using futurePayments", async function() {
    ...
    await token.submitBid({ value: price*700000, from: accounts[1] });
    await token.submitBid({ value: price*400000, from: accounts[2] });
    ...
    totalTokensBought += 200000;
    totalTokensBought += 500000;
    await token.submitBid({ value: price*200000, from: accounts[3] });
    await token.submitBid({ value: price*200000, from: accounts[4] });
    await token.submitBid({ value: price*500000, from: accounts[5] });
    await help.waitToBlock(startBlock+20, accounts);
    ...
    await token.submitBid({ value: price*600000, from: accounts[6] });
    await token.submitBid({ value: price*900000, from: accounts[7] });
    ...
    totalTokensBought += 500000;
    await token.submitBid({ value: price*500000, from: accounts[8] });
    ...
    await token.submitBid({ value: price*100000, from: accounts[3] });
    await token.submitBid({ value: price*300000, from: accounts[4] });
    await help.waitToBlock(startBlock+10, accounts);
    ...
    totalWeiSent += price*400000;
    totalTokensBought += 400000;
    await token.submitBid({ value: price*400000, from: accounts[6] });
    await help.waitToBlock(startBlock+20, accounts);
    ...
    totalTokensBought += 600000;
    totalTokensBought += 600000;
    await token.submitBid({ value: price*600000, from: accounts[7] });
    await token.submitBid({ value: price*600000, from: accounts[8] });
    ...
    totalTokensBought += 300000;
    await token.submitBid({ value: price*175000, from: accounts[1] });
    await token.submitBid({ value: price*300000, from: accounts[2] });
